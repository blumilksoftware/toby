...
<template>
  ...
  >
    <div class="relative">
      <ComboboxInput
        :id="id"
        class="w-full h-12 rounded-md border border-gray-300 bg-white py-2 pl-3 pr-10 shadow-xs focus:border-blumilk-500 focus:outline-hidden focus:ring-1 focus:ring-blumilk-500 sm:text-sm"
