  ...
  <GuestLayout>
    ...
    >
      <div
        ...
        class="overflow-hidden absolute inset-x-2 top-2 bg-red-500 rounded-lg ring-1 ring-black/5 shadow-lg pointer-events-auto sm:mx-auto sm:w-full sm:max-w-md"
      >
        <div class="p-4">
          <div class="flex items-center">
            <div class="flex flex-1 justify-between w-0">
              <ExclamationTriangleIcon class="mr-1 size-5 text-white" />
