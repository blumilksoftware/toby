...
<template>
  <InertiaHead title="Edycja uprawnień" />
  <div class="bg-white shadow-md">
    ...
    <div class="items-center py-4 px-4 flex">
      <div class="flex">
        <img
          class="w-14 h-14 mt-1 rounded-full"
          :src="user.avatar"
        >
        <div class="ml-3">
    ...
    >
      ...
      >
        <div
          ...
          class="w-full mt-4 mb-4 border border-gray-200 items-start"
        >
          <div
