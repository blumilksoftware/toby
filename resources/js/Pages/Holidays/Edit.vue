        ...
        <div class="items-center py-4 sm:grid sm:grid-cols-3">
          ...
          <div class="mt-1 sm:col-span-2 sm:mt-0">
            <FlatPickr
              ...
              v-model="form.date"
              class="block w-full max-w-lg rounded-md shadow-xs sm:text-sm"
              :class="{ 'border-red-300 text-red-900 focus:outline-hidden focus:ring-red-500 focus:border-red-500': form.errors.date, 'focus:ring-blumilk-500 focus:border-blumilk-500 sm:text-sm border-gray-300': !form.errors.date }"
            />
            <p
