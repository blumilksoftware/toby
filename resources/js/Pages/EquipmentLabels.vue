                      ...
                      <div class="py-1">
                        ...
                        >
                          <InertiaLink
                            ...
                            method="delete"
                            preserve-scroll
                            :href="`/equipment-labels/${label.id}`"
            ...
            <tr v-if="!labels.data.length">
              ...
              >
                <EmptyState>
                  ...
                  <template #text>
                    Brak wpisów dotyczących etykiet sprzętu.
                  </template>
                </EmptyState>
              </td>
            </tr>
      ...
      <div class="flex justify-center items-end px-4 pt-4 pb-20 min-h-screen text-center sm:block sm:p-0">
        ...
        >
          <form
            ...
            @submit.prevent="submitCreateLabel"
          >
            <div>
              <div>
                <DialogTitle
